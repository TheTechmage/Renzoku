...
nnoremap <F5> m'A="\t".strftime('%a %b %e %H:%M:%S %Z %Y')``
...
set tabstop=2
set tags=./tags,./TAGS,tags,TAGS,.git/tags,.svn/tags
set titlestring=vim(tokenizer.cpp)
set updatetime=2000
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/projects/cpp/builder
...
badd +0 main.hpp
badd +0 signals.hpp
badd +0 test_config.cpp
badd +0 process.cpp
badd +0 process.hpp
badd +0 log.cpp
badd +0 log.hpp
badd +0 test_log.cpp
badd +0 test_process.cpp
argglobal
silent! argdel *
argadd tokenizer.cpp
argadd tokenizer.hpp
edit tokenizer.cpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((41 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
normal! 05|
tabedit test_tokenizer.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
157,176fold
178,208fold
let s:l = 29 - ((20 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((28 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
