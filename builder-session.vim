...
badd +0 watcher.cpp
badd +0 config.cpp
badd +8 i_configfile.hpp
badd +14 configvalue.hpp
badd +15 configvalue.cpp
badd +0 configfile.hpp
badd +0 configfile.cpp
badd +0 configitem.hpp
badd +0 configitem.cpp
argglobal
silent! argdel *
argadd Makefile
argadd watcher.cpp
...
exe 'vert 4resize ' . ((&columns * 132 + 132) / 265)
exe '5resize ' . ((&lines * 31 + 33) / 66)
exe 'vert 5resize ' . ((&columns * 132 + 132) / 265)
argglobal
edit i_configfile.hpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
